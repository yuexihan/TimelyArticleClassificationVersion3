...
i = 0
for a, b in zip(itertools.chain(open('data/20180612.positive', encoding='utf-8'), open('data/20180612.negative', encoding='utf-8')), open(FLAGS.predictions, encoding='utf-8')):
